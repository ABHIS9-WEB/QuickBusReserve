...
public interface JourneyBookingService {
	...
	List<JourneyBooking> getByJourneyAndStatusNotInAndJourneyClass(Journey journey, List<String> status, Object object);
	...
	List<JourneyBooking> getByJourneyAndStatusNotInAndJourneyClass(Journey journey, List<String> status,
			String journeyClass);
